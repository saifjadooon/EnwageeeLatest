...
package com.example.envagemobileapplication.Models.ResponseModels.TokenResponse.tokenresp.GetAssesmentForms;
...
public class Datum {
    ...
    @Expose
    private List<Object> clientAssessmentFormSections;
    ...
    public List<Object> getClientAssessmentFormSections() {
        return clientAssessmentFormSections;
    }

    public void setClientAssessmentFormSections(List<Object> clientAssessmentFormSections) {
