package com.example.envagemobileapplication.Activities.Client.AddClient.ClientSummary
...
import com.example.envagemobileapplication.Activities.Client.AddClient.ClientSummary.ClientSummaryFragments.ClientSummaryContactsFragment
...
import com.example.envagemobileapplication.Activities.Client.AddClient.ClientSummary.ClientSummaryFragments.ClientSummaryJobRequisitionF
...
class ClientSummaryActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val itemList = listOf(
            ...
            Pair("Job Requisition", R.drawable.ic_jobreq),
        ...
        for ((itemText, drawableResId) in itemList) {
            ...
            itemView.setOnClickListener(object : View.OnClickListener {
                override fun onClick(v: View) {
                    ...
                    else if (clickedText.equals("Job Requisition")) {
                        // navController.navigateUp()
                        //   navController.navigate(R.id.clientSummaryContactsFragment);
