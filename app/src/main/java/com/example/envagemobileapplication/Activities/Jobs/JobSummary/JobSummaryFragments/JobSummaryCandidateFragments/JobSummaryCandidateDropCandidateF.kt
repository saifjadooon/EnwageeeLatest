...
import com.example.envagemobileapplication.Adapters.JobDroppedCandidateAdapter
import com.example.envagemobileapplication.Activities.DashBoard.DashboardFragments.BottomSheet.BottomsheetJobCandidatesDropKMenu
...
import com.example.envagemobileapplication.databinding.FragmentJobSummaryCandidateDropCandidateBinding
...
class JobSummaryCandidateDropCandidateF : Fragment() {
    ...
    lateinit var binding: FragmentJobSummaryCandidateDropCandidateBinding
    val viewModel: JobSummaryCandidateViewModel by activityViewModels()


    var global = com.example.envagemobileapplication.Utils.Global
    lateinit var model: SortDirectionCandidateDropCandidate
    ...
    val bottomSheetFragment = BottomsheetJobCandidatesDropKMenu()
    private var currentPage = 1
    private var isLoading = false
    lateinit var adapter: JobDroppedCandidateAdapter
    lateinit var onlineApplicantsList: ArrayList<com.example.envagemobileapplication.Models.ResponseModels.TokenResponse.tokenresp.GetDropJobCandidateRes.Record>
    ...
    override fun onCreateView(
        ...
        binding =  FragmentJobSummaryCandidateDropCandidateBinding.inflate(inflater, container, false)
        return binding.root
    ...
    private fun observers() {
        ...
        viewModel.LDshowJobCandidateDropKebabmenuBottomSheet.observe(requireActivity()) {

            Log.d("The data is ",it.toString())
        ...
        viewModel.LDgetJObDroppedCandidates.observe(requireActivity()) {
            loader.hide()
            if (it != null) {
                ...
                if (it.data.records.size >= 1) {
                    ...
                    binding.tvNoDroppedCandidates.visibility = View.GONE
                    ...
                    binding.tvNoDroppedCandidates.visibility = View.VISIBLE
        ...
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                if (query.length < 3) {
                    ...
                    model = SortDirectionCandidateDropCandidate(
                        candidateFilters = emptyList(),
                        jobGUID = Global.jobGuid!!,
                        pageIndex = 1,
                        pageSize = 25,
    ...
    private fun loadMoreData(page: Int) {
        ...
        try {
            ...
            lifecycleScope.launch {
                ...
                try {
                    ApiUtils.getAPIService(requireContext()).getjobDroppedcandidatess(
                        model,
                        token,
                    )
    ...
    private fun setupCandidateAdapter(jobCandidateList: ArrayList<com.example.envagemobileapplication.Models.ResponseModels.TokenResponse.tokenresp.GetDropJobCandidateRes.Record>) {

        try {
            binding.rvCandidates.setHasFixedSize(true)

            adapter = JobDroppedCandidateAdapter(
                requireContext(),
