...
import com.example.envagemobileapplication.Activities.Jobs.AddJobFragments.AddjobSalaryDetailF
...
import com.example.envagemobileapplication.databinding.FragmentAddressDetailBinding
...
class AddressDetailF : Fragment() {
    ...
    private fun clickListeners() {
        ...
        binding.btnNext.setOnClickListener {
            ...
            if (!address1.isNullOrEmpty() && !address2.isNullOrEmpty()) {
                ...
                EditJobRequisitionActivity.binding.ivThree.setImageDrawable(
                    requireContext().getDrawable(
                        com.example.envagemobileapplication.R.drawable.ic_address_detail_done
                    )
                )
                replaceFragment(SalaryDetailF())
    ...
    private fun initViews() {
        ...
        EditJobRequisitionActivity.binding.ivThree.setImageDrawable(requireContext().getDrawable(com.example.envagemobileapplication.R.drawable.ic_active_three))
        ...
        if (global.jobReqbyJobid!!.address1 != null) {
            binding.etAdress1.setText(global.jobReqbyJobid!!.address1)
        }
        if (global.jobReqbyJobid!!.address2 != null) {
            binding.etAdress2.setText(global.jobReqbyJobid!!.address2)
        }

        if (global.jobReqbyJobid!!.country != null) {
            binding.spinnerCountry.setText(global.jobReqbyJobid!!.country)
        }
        if (global.jobReqbyJobid!!.zipcode != null) {
            binding.etZipcode.setText(global.jobReqbyJobid!!.zipcode)
        }
        if (global.jobReqbyJobid!!.city != null) {
            binding.etCity.setText(global.jobReqbyJobid!!.city)
        }
        if (global.jobReqbyJobid!!.state != null) {
            binding.etState.setText(global.jobReqbyJobid!!.state)
        }
        if (global.jobReqbyJobid!!.location != null) {
            binding.etLocation.setText(global.jobReqbyJobid!!.location.toString())
        }
