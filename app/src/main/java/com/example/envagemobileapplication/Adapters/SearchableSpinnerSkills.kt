...
import com.example.envagemobileapplication.Utils.CircularReveal
...
class SearchableSpinnerSkills(private val context: Context) : LifecycleObserver {
    ...
    private lateinit var recyclerAdapter: com.example.envagemobileapplication.Adapters.SpinnerCheckboxRecyclerAdapter
    ...
    fun setSpinnerListItems(spinnerList: ArrayList<String>) {
        if (isfromsearch) {
            ...
            recyclerAdapter =
                SpinnerCheckboxRecyclerAdapter(context, datalist, object : OnItemSelectListener {
            ...
            recyclerAdapter =
                SpinnerCheckboxRecyclerAdapter(context, spinnerList, object : OnItemSelectListener {
                    override fun setOnItemSelectListener(position: Int, selectedString: String) {
                        selectedItemPosition = position
                        selectedItem = selectedString
                        if (dismissSpinnerOnItemClick) dismiss()
                ...
                .enqueue(object : Callback<SearchJobsClientsResp> {
                    override fun onResponse(
                        ...
                        if (response.body() != null) {
                            ...
                            val adapter = SpinnerCheckboxRecyclerAdapter(
                                context,
                                datalist,
